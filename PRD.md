...
| **Laugher (笑者)** | **仅走窗户 (Scene 2)** | **行动不规律**：有时在窗外远处站着不动，有时在窗外贴脸凝视不动，有时躲在窗后盲区（可能看不到）。<br>**攻击机制**：决定攻击时必定发出诡异笑声与敲窗声，并贴在窗前，数秒后立即破窗。<br>**并发限制**：同一时间窗外最多仅有 1 只 Laugher。 | 听到笑声或敲玻璃声时立即切至窗口将其击杀。 |
